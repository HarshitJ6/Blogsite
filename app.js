...
app.get("/", function (req, res) {
  Post.find({}, function (err, foundItems) {
    if (err) {
      ...
      res.render(page, { homeContent: homeStartingContent, arr: foundItems });
    }
  });
});
...
app.get("/posts/:postId", function (req, res) {
  // let parameter = _.lowerCase(req.params.anystring);
  ...
  Post.findOne({_id: requestedPostId}, function(err, post){  res.render("post", {
